...
import Addquestionstrivia from "./Addquestionstrivia";
...
const Questionstrivia = () => {
  ...
  const fetchdata = async (page = 1, limit = 10) => {
    ...
    const response = await axios.get(
      `contestserv/fetch_trivia_app_questions_admin?page=${page}&limit=${limit}&query=${query}`,
      config
    );
  ...
  return (
    <>
      ...
      <div className="p-4">
        ...
        <Addquestionstrivia setreload={setreload} reload={reload} />
